 ...
 *
 */
public class GetSystemRightsColonResponseConverterTests {

    private GetSystemRightsResponseConverter converter = new GetSystemRightsResponseConverter(PumapiUtil.COLON);
